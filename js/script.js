    ...
    let tab = {
            ...
            start: function () {
                ...
                if (sessionStorage.getItem('currentTab')) {
                    ...
                    that.currentTab = parseInt(sessionStorage.getItem('currentTab'));
                } else {
                    showTab(0);
                }
                ...
                function showTab(i) {
                    ...
                    $('html, body').animate({
                        scrollTop: that.tabsItems[i].offsetTop
                    }, 500);
                    ...
                    window.scrollTo({
                        top: that.tabsItems[i].offsetTop,
                        behavior: "smooth"
                    });
